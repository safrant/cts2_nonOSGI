...
/**
 * A synopsis of a Statement along with information about how to
 * access the complete resource.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class StatementDirectoryEntry extends edu.mayo.cts2.framework.model.statement.Statement 
implements java.io.Serializable
{
    ...
    public boolean equals(
        ...
        if (obj instanceof StatementDirectoryEntry) {

            StatementDirectoryEntry temp = (StatementDirectoryEntry)obj;
            if (this._href != null) {
    ...
    /**
     * Method unmarshalStatementDirectoryEntry.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling

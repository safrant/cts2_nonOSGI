...
public class ResolvedReadContext {
	...
	public String getChangeSetContextUri() {
		return changeSetContextUri;
	}

	public void setChangeSetContextUri(String changeSetContextUri) {
	...
	public boolean equals(Object obj)
	{
		...
		{
            return other.returnContentFilter == null;
		}
		else return returnContentFilter.equals(other.returnContentFilter);
    }
}

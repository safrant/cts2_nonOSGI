...
/**
 * A collection of complete MapVersion resources that meet a
 * specified criteria.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class MapVersionList extends edu.mayo.cts2.framework.model.core.Directory 
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<MapVersionListEntry> _entryList;
    ...
    public MapVersionList() {
        super();
        this._entryList = new java.util.ArrayList<MapVersionListEntry>();
    }
    ...
    public void addEntry(
            final MapVersionListEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends MapVersionListEntry> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof MapVersionList) {

            MapVersionList temp = (MapVersionList)obj;
     ...
     * edu.mayo.cts2.framework.model.mapversion.MapVersionListEntry
     * at the given index
     */
    ...
    public MapVersionListEntry[] getEntry(
        ...
        MapVersionListEntry[] array = new MapVersionListEntry[0];
     ...
     */
    public java.util.List<MapVersionListEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends MapVersionListEntry> iterateEntry(
    ) {
     ...
     */
    public MapVersionListEntry removeEntryAt(
            final int index) {
        MapVersionListEntry obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final MapVersionListEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<MapVersionListEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<MapVersionListEntry> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalMapVersionList.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.mapversion.MapVersionList
     */

...
public class ResolvedValueSetDirectory extends Directory
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<ResolvedValueSetDirectoryEntry> _entryList;
    ...
    public ResolvedValueSetDirectory() {
        super();
        this._entryList = new java.util.ArrayList<ResolvedValueSetDirectoryEntry>();
    }
    ...
    public void addEntry(
            final ResolvedValueSetDirectoryEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ResolvedValueSetDirectoryEntry> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof ResolvedValueSetDirectory) {

            ResolvedValueSetDirectory temp = (ResolvedValueSetDirectory)obj;
     ...
     * edu.mayo.cts2.framework.model.valuesetdefinition.ResolvedValueSetDirectoryEntry
     * at the given index
     */
    public ResolvedValueSetDirectoryEntry getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public ResolvedValueSetDirectoryEntry[] getEntry(
        ...
        ResolvedValueSetDirectoryEntry[] array = new ResolvedValueSetDirectoryEntry[0];
     ...
     */
    public java.util.List<ResolvedValueSetDirectoryEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ResolvedValueSetDirectoryEntry> iterateEntry(
    ) {
     ...
     */
    public ResolvedValueSetDirectoryEntry removeEntryAt(
            final int index) {
        ResolvedValueSetDirectoryEntry obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final ResolvedValueSetDirectoryEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<ResolvedValueSetDirectoryEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<ResolvedValueSetDirectoryEntry> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalResolvedValueSetDirectory.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.valuesetdefinition.ResolvedValueSetDirectory
     */

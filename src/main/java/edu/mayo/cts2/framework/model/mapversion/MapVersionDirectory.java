...
/**
 * A directory of MapVersion resources that meet a specified
 * criteria.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class MapVersionDirectory extends edu.mayo.cts2.framework.model.core.Directory 
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<MapVersionDirectoryEntry> _entryList;
    ...
    public MapVersionDirectory() {
        super();
        this._entryList = new java.util.ArrayList<MapVersionDirectoryEntry>();
    }
    ...
    public void addEntry(
            final MapVersionDirectoryEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends MapVersionDirectoryEntry> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof MapVersionDirectory) {

            MapVersionDirectory temp = (MapVersionDirectory)obj;
    ...
    public MapVersionDirectoryEntry[] getEntry(
        ...
        MapVersionDirectoryEntry[] array = new MapVersionDirectoryEntry[0];
     ...
     */
    public java.util.List<MapVersionDirectoryEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends MapVersionDirectoryEntry> iterateEntry(
    ) {
     ...
     */
    public MapVersionDirectoryEntry removeEntryAt(
            final int index) {
        MapVersionDirectoryEntry obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final MapVersionDirectoryEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<MapVersionDirectoryEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<MapVersionDirectoryEntry> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalMapVersionDirectory.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.mapversion.MapVersionDirectory
     */

...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<EntityDirectoryEntry> _entryList;
    ...
    public EntityDirectory() {
        super();
        this._entryList = new java.util.ArrayList<EntityDirectoryEntry>();
    }
    ...
    public void addEntry(
            final EntityDirectoryEntry vEntry)
    ...
    public boolean equals(
        ...
        if (obj instanceof EntityDirectory) {

            EntityDirectory temp = (EntityDirectory)obj;
     ...
     * edu.mayo.cts2.framework.model.entity.EntityDirectoryEntry at
     * the given index
     */
    ...
    public EntityDirectoryEntry[] getEntry(
        ...
        EntityDirectoryEntry[] array = new EntityDirectoryEntry[0];
     ...
     */
    public EntityDirectoryEntry removeEntryAt(
            final int index) {
        EntityDirectoryEntry obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final EntityDirectoryEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<EntityDirectoryEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<EntityDirectoryEntry> entryList) {
     ...
     * edu.mayo.cts2.framework.model.entity.EntityDirectory
     */

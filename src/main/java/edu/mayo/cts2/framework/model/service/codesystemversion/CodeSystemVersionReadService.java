...
/**
 * Class CodeSystemVersionReadService.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class CodeSystemVersionReadService extends edu.mayo.cts2.framework.model.service.core.BaseReadService 
implements java.io.Serializable
{
    ...
    public CodeSystemVersionReadService() {
        super();
    ...
    public boolean equals(
        ...
        if (obj instanceof CodeSystemVersionReadService) {

            CodeSystemVersionReadService temp = (CodeSystemVersionReadService)obj;
    ...
    /**
     * Method unmarshalCodeSystemVersionReadService.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling

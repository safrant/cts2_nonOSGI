...
/**
 * An ordered list of ChangeSetEntrys. The order of the list
 * reflects the order in which the change sets were applied to the
 * service instance
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ChangeSetEntryList extends edu.mayo.cts2.framework.model.BaseCts2ModelObject 
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<ChangeSetEntry> _entryList;
    ...
    public ChangeSetEntryList() {
        super();
        this._entryList = new java.util.ArrayList<ChangeSetEntry>();
    }
     ...
     * collection
     */
    public java.util.Enumeration<? extends ChangeSetEntry> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof ChangeSetEntryList) {

            ChangeSetEntryList temp = (ChangeSetEntryList)obj;
     ...
     * edu.mayo.cts2.framework.model.service.core.ChangeSetEntry at
     * the given index
     */
    ...
    public ChangeSetEntry[] getEntry(
        ...
        ChangeSetEntry[] array = new ChangeSetEntry[0];
     ...
     */
    public java.util.List<ChangeSetEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ChangeSetEntry> iterateEntry(
    ) {
     ...
     */
    public ChangeSetEntry removeEntryAt(
            final int index) {
        ChangeSetEntry obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final ChangeSetEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<ChangeSetEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<ChangeSetEntry> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalChangeSetEntryList.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.service.core.ChangeSetEntryList
     */

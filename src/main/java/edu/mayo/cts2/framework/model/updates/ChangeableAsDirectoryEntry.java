...
public class ChangeableAsDirectoryEntry extends edu.mayo.cts2.framework.model.updates.ChangeableResource 
implements java.io.Serializable
{
    ...
    public boolean equals(
        ...
        if (obj instanceof ChangeableAsDirectoryEntry) {

            ChangeableAsDirectoryEntry temp = (ChangeableAsDirectoryEntry)obj;
            if (this._href != null) {
    ...
    /**
     * Method unmarshalChangeableAsDirectoryEntry.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling

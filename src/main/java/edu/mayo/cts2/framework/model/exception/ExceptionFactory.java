...
public class ExceptionFactory {
	...
	public static UnknownResourceReference createUnsupportedComponentReference(
        ...
        ex.setCts2Message(getPossibleValuesMessageFromComponentReference(componentReference, componentReferences));
	...
	public static UnspecifiedCts2Exception createUnknownException(
		...
		sb.append(" Request was: ").append(url);
		
		if(StringUtils.isNotBlank(paramString)){
			sb.append(", Parameters were: ").append(paramString);
		}
    ...
    private static OpaqueData getPossibleValuesMessageFromComponentReference(
        ...
        return getPossibleValuesMessageFromComponentReference("ComponentReference", nameOrUri, possibleValues);
    }
	...
	private static String nameAndMeaningRefToString(NameAndMeaningReference ref){
		...
		sb.append("Name: ").append(ref.getContent());
		
		if(ref.getUri() != null && !ref.getUri().isEmpty()){
			sb.append(", ");
			sb.append("URI: ").append(ref.getUri());
		}
		
		if(ref.getHref() != null && !ref.getHref().isEmpty()){
			sb.append(", ");
			sb.append("Href: ").append(ref.getHref());
		}
	...
	private static String componentRefToString(ComponentReference ref){
		...
		if(ref.getAttributeReference() != null){
			sb.append("Attribute Name: ").append(ref.getAttributeReference());
			...
			if(propertyReference.getUri() != null){
				sb.append("Property URI: ").append(propertyReference.getUri());
			}
			
			if(propertyReference.getDesignation() != null){
				sb.append("Property Designation: ").append(propertyReference.getDesignation());
			}
			
			if(propertyReference.getHref() != null){
				sb.append("Property Href: ").append(propertyReference.getHref());
			}
			
			sb.append(StringUtils.join(segments.toArray(), ", "));
		} else if (ref.getSpecialReference() != null){
			sb.append("Special Reference Name: ").append(ref.getSpecialReference());
		} else {
	...
	private static OpaqueData getPossibleValuesMessage(
		...
		sb.append(type).append(": ").append(requestedValue).append(" not found. ");
		
		if(possibleValues != null && possibleValues.size() != 0){
				
			sb.append("Available ").append(type).append("s for this request: ");

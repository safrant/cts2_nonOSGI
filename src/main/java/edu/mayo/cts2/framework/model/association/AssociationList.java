...
/**
 * A collection of complete Association resources that meet a
 * specified criteria.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class AssociationList extends Directory
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<AssociationListEntry> _entryList;
    ...
    public AssociationList() {
        super();
        this._entryList = new java.util.ArrayList<AssociationListEntry>();
    }
    ...
    public void addEntry(
            final AssociationListEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends AssociationListEntry> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof AssociationList) {
            ...
            AssociationList temp = (AssociationList)obj;
     ...
     * edu.mayo.cts2.framework.model.association.AssociationListEntry
     * at the given index
     */
    ...
    public AssociationListEntry[] getEntry(
        ...
        AssociationListEntry[] array = new AssociationListEntry[0];
     ...
     */
    public java.util.List<AssociationListEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends AssociationListEntry> iterateEntry(
    ) {
     ...
     */
    public AssociationListEntry removeEntryAt(
            final int index) {
        AssociationListEntry obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final AssociationListEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<AssociationListEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<AssociationListEntry> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalAssociationList.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.association.AssociationList
     */

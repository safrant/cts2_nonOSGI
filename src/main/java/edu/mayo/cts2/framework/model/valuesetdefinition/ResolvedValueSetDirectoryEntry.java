...
public class ResolvedValueSetDirectoryEntry extends edu.mayo.cts2.framework.model.valuesetdefinition.ResolvedValueSetSummary 
implements java.io.Serializable
{
    ...
    public ResolvedValueSetDirectoryEntry() {
        super();
    }
    ...
    public boolean equals(
        ...
        if (obj instanceof ResolvedValueSetDirectoryEntry) {

            ResolvedValueSetDirectoryEntry temp = (ResolvedValueSetDirectoryEntry)obj;
            if (this._href != null) {
    ...
    /**
     * Method unmarshalResolvedValueSetDirectoryEntry.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling

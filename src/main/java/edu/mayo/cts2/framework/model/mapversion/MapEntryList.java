...
/**
 * A collection of complete MapEntries that meet a specified
 * criteria.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class MapEntryList extends edu.mayo.cts2.framework.model.core.Directory 
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<MapEntryListEntry> _entryList;
    ...
    public MapEntryList() {
        super();
        this._entryList = new java.util.ArrayList<MapEntryListEntry>();
    }
    ...
    public void addEntry(
            final MapEntryListEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends MapEntryListEntry> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof MapEntryList) {

            MapEntryList temp = (MapEntryList)obj;
     ...
     * edu.mayo.cts2.framework.model.mapversion.MapEntryListEntry
     * at the given index
     */
    public MapEntryListEntry getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public MapEntryListEntry[] getEntry(
        ...
        MapEntryListEntry[] array = new MapEntryListEntry[0];
     ...
     */
    public java.util.List<MapEntryListEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends MapEntryListEntry> iterateEntry(
    ) {
     ...
     */
    public MapEntryListEntry removeEntryAt(
            final int index) {
        MapEntryListEntry obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final MapEntryListEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<MapEntryListEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<MapEntryListEntry> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalMapEntryList.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.mapversion.MapEntryList
     */

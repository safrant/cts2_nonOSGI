...
public class OntologyDomainReference extends NameAndMeaningReference
implements java.io.Serializable
{
    ...
    public OntologyDomainReference() {
        super();
        setContent("");
    }

    public OntologyDomainReference(final String defaultValue) {
        try {
    ...
    public boolean equals(
        ...
        if (obj instanceof OntologyDomainReference) {

            OntologyDomainReference temp = (OntologyDomainReference)obj;
    ...
    /**
     * Method unmarshalOntologyDomainReference.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling

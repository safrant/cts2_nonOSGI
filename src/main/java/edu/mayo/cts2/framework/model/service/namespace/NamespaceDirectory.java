...
public class NamespaceDirectory extends Directory
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<DocumentedNamespaceReference> _entryList;
    ...
    public NamespaceDirectory() {
        super();
        this._entryList = new java.util.ArrayList<DocumentedNamespaceReference>();
    }
    ...
    public void addEntry(
            final DocumentedNamespaceReference vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends DocumentedNamespaceReference> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof NamespaceDirectory) {

            NamespaceDirectory temp = (NamespaceDirectory)obj;
     ...
     * at the given index
     */
    public DocumentedNamespaceReference getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public DocumentedNamespaceReference[] getEntry(
        ...
        DocumentedNamespaceReference[] array = new DocumentedNamespaceReference[0];
     ...
     */
    public java.util.List<DocumentedNamespaceReference> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends DocumentedNamespaceReference> iterateEntry(
    ) {
     ...
     */
    public DocumentedNamespaceReference removeEntryAt(
            final int index) {
        DocumentedNamespaceReference obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final DocumentedNamespaceReference[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<DocumentedNamespaceReference> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<DocumentedNamespaceReference> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalNamespaceDirectory.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.service.namespace.NamespaceDirectory
     */

...
public class MapEntryListEntry extends edu.mayo.cts2.framework.model.core.DirectoryEntry 
implements java.io.Serializable
{
    ...
    public boolean equals(
        ...
        if (obj instanceof MapEntryListEntry) {

            MapEntryListEntry temp = (MapEntryListEntry)obj;
            if (this._entry != null) {
    ...
    /**
     * Method unmarshalMapEntryListEntry.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling

...
/**
 * A directory of CodeSystemVersion resources that meet a specified
 * criteria.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class CodeSystemVersionCatalogEntryDirectory extends Directory
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<CodeSystemVersionCatalogEntrySummary> _entryList;
    ...
    public CodeSystemVersionCatalogEntryDirectory() {
        super();
        this._entryList = new java.util.ArrayList<CodeSystemVersionCatalogEntrySummary>();
    }
    ...
    public void addEntry(
            final CodeSystemVersionCatalogEntrySummary vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends CodeSystemVersionCatalogEntrySummary> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof CodeSystemVersionCatalogEntryDirectory) {

            CodeSystemVersionCatalogEntryDirectory temp = (CodeSystemVersionCatalogEntryDirectory)obj;
     ...
     * at the given index
     */
    public CodeSystemVersionCatalogEntrySummary getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public CodeSystemVersionCatalogEntrySummary[] getEntry(
        ...
        CodeSystemVersionCatalogEntrySummary[] array = new CodeSystemVersionCatalogEntrySummary[0];
     ...
     */
    public java.util.List<CodeSystemVersionCatalogEntrySummary> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends CodeSystemVersionCatalogEntrySummary> iterateEntry(
    ) {
     ...
     */
    public CodeSystemVersionCatalogEntrySummary removeEntryAt(
            final int index) {
        CodeSystemVersionCatalogEntrySummary obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final CodeSystemVersionCatalogEntrySummary[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<CodeSystemVersionCatalogEntrySummary> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<CodeSystemVersionCatalogEntrySummary> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalCodeSystemVersionCatalogEntryDirectory.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.codesystemversion.CodeSystemVersionCatalogEntryDirectory
     */

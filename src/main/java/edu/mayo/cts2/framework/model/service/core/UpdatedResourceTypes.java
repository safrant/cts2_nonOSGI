...
implements java.io.Serializable
{
     ...
     */
    private java.util.List<edu.mayo.cts2.framework.model.core.EntityReference> _resourceTypeList;
    ...
    public UpdatedResourceTypes() {
        super();
        this._resourceTypeList = new java.util.ArrayList<edu.mayo.cts2.framework.model.core.EntityReference>();
    }
    ...
    public void addResourceType(
            final edu.mayo.cts2.framework.model.core.EntityReference vResourceType)
     ...
     * collection
     */
    public java.util.Enumeration<? extends edu.mayo.cts2.framework.model.core.EntityReference> enumerateResourceType(
    ) {
     ...
     * edu.mayo.cts2.framework.model.core.EntityReference at the
     * given index
     */
    public edu.mayo.cts2.framework.model.core.EntityReference getResourceType(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public edu.mayo.cts2.framework.model.core.EntityReference[] getResourceType(
        ...
        edu.mayo.cts2.framework.model.core.EntityReference[] array = new edu.mayo.cts2.framework.model.core.EntityReference[0];
     ...
     */
    public java.util.List<edu.mayo.cts2.framework.model.core.EntityReference> getResourceTypeAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends edu.mayo.cts2.framework.model.core.EntityReference> iterateResourceType(
    ) {
     ...
     */
    public edu.mayo.cts2.framework.model.core.EntityReference removeResourceTypeAt(
            final int index) {
        EntityReference obj = this._resourceTypeList.remove(index);
        return obj;
    }
     ...
     */
    public void setResourceType(
            final edu.mayo.cts2.framework.model.core.EntityReference[] vResourceTypeArray) {
        //-- copy array
     ...
     */
    public void setResourceType(
            final java.util.List<edu.mayo.cts2.framework.model.core.EntityReference> vResourceTypeList) {
        // copy vector
        this._resourceTypeList.clear();
    ...
    public void setResourceTypeAsReference(
            final java.util.List<edu.mayo.cts2.framework.model.core.EntityReference> resourceTypeList) {
     ...
     * edu.mayo.cts2.framework.model.service.core.UpdatedResourceTypes
     */

...
/**
 * The result of resolving a specific value set definition against
 * a known set of code system versions. ResolvedValueSet consists
 * of a header that carries sufficient information that the
 * resolution
 *  operation would be repeatable and the result of the resolution,
 * which consists of set of EntityReferences.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ResolvedValueSet extends edu.mayo.cts2.framework.model.BaseCts2ModelObject 
implements java.io.Serializable
{
     ...
     */
    private ResolvedValueSetHeader _resolutionInfo;
     ...
     */
    private java.util.List<URIAndEntityName> _entryList;
    ...
    public ResolvedValueSet() {
        super();
        this._entryList = new java.util.ArrayList<URIAndEntityName>();
    }
     ...
     * collection
     */
    public java.util.Enumeration<? extends URIAndEntityName> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof ResolvedValueSet) {

            ResolvedValueSet temp = (ResolvedValueSet)obj;
     ...
     * given index
     */
    public URIAndEntityName getEntry(
            final int index)
    throws IndexOutOfBoundsException {
     ...
     */
    public java.util.List<URIAndEntityName> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends URIAndEntityName> iterateEntry(
    ) {
     ...
     */
    public URIAndEntityName removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final URIAndEntityName[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<URIAndEntityName> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<URIAndEntityName> entryList) {
    ...
    public void setResolutionInfo(
            final ResolvedValueSetHeader resolutionInfo) {
        this._resolutionInfo = resolutionInfo;
    }

    /**
     * Method unmarshalResolvedValueSet.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.valuesetdefinition.ResolvedValueSet
     */

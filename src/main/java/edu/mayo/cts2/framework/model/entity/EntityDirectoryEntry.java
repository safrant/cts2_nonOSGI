...
/**
 * A synopsis of an Entity along with information about how to
 * access the complete resource.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class EntityDirectoryEntry extends edu.mayo.cts2.framework.model.core.EntityReference 
implements java.io.Serializable
{
    ...
    public boolean equals(
        ...
        if (obj instanceof EntityDirectoryEntry) {

            EntityDirectoryEntry temp = (EntityDirectoryEntry)obj;
            if (this._href != null) {
     ...
     * edu.mayo.cts2.framework.model.entity.EntityDirectoryEntry
     */

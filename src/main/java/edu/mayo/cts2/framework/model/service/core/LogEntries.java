...
/**
 * A ordered sequence of log entries. The order of the entries is
 * determined by the specific CTS2 service implementation and
 * should not be assumed by client applications.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class LogEntries extends edu.mayo.cts2.framework.model.BaseCts2ModelObject 
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<LogEntry> _entryList;
    ...
    public LogEntries() {
        super();
        this._entryList = new java.util.ArrayList<LogEntry>();
    }
     ...
     * collection
     */
    public java.util.Enumeration<? extends LogEntry> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof LogEntries) {
            ...
            LogEntries temp = (LogEntries)obj;
     ...
     */
    public java.util.List<LogEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends LogEntry> iterateEntry(
    ) {
     ...
     */
    public LogEntry removeEntryAt(
            final int index) {
        LogEntry obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final java.util.List<LogEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<LogEntry> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalLogEntries.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.service.core.LogEntries
     */

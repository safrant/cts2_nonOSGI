...
/**
 * An element that can evolve over time. All Changeable elements
 * must have identity.
 * 
...
implements java.io.Serializable, IsChangeable
{
     ...
     */
    private edu.mayo.cts2.framework.model.core.types.EntryState _entryState = edu.mayo.cts2.framework.model.core.types.EntryState.fromValue("ACTIVE");
    ...
    public Changeable() {
        super();
        setEntryState(edu.mayo.cts2.framework.model.core.types.EntryState.fromValue("ACTIVE"));
    }
    ...
    public boolean equals(
        ...
        if (obj instanceof Changeable) {
            ...
            Changeable temp = (Changeable)obj;

...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<edu.mayo.cts2.framework.model.mapversion.MapTarget> _entryList;
    ...
    public MapTargetList() {
        super();
        this._entryList = new java.util.ArrayList<edu.mayo.cts2.framework.model.mapversion.MapTarget>();
    }
    ...
    public void addEntry(
            final edu.mayo.cts2.framework.model.mapversion.MapTarget vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends edu.mayo.cts2.framework.model.mapversion.MapTarget> enumerateEntry(
    ) {
     ...
     * given index
     */
    public edu.mayo.cts2.framework.model.mapversion.MapTarget getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public edu.mayo.cts2.framework.model.mapversion.MapTarget[] getEntry(
        ...
        edu.mayo.cts2.framework.model.mapversion.MapTarget[] array = new edu.mayo.cts2.framework.model.mapversion.MapTarget[0];
     ...
     */
    public java.util.List<edu.mayo.cts2.framework.model.mapversion.MapTarget> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends edu.mayo.cts2.framework.model.mapversion.MapTarget> iterateEntry(
    ) {
     ...
     */
    public edu.mayo.cts2.framework.model.mapversion.MapTarget removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final edu.mayo.cts2.framework.model.mapversion.MapTarget[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<edu.mayo.cts2.framework.model.mapversion.MapTarget> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<edu.mayo.cts2.framework.model.mapversion.MapTarget> entryList) {

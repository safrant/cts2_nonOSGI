...
public class EntityNameOrURIList extends edu.mayo.cts2.framework.model.BaseCts2ModelObject 
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<edu.mayo.cts2.framework.model.service.core.EntityNameOrURI> _entryList;
    ...
    public EntityNameOrURIList() {
        super();
        this._entryList = new java.util.ArrayList<edu.mayo.cts2.framework.model.service.core.EntityNameOrURI>();
    }
    ...
    public void addEntry(
            final edu.mayo.cts2.framework.model.service.core.EntityNameOrURI vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends edu.mayo.cts2.framework.model.service.core.EntityNameOrURI> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof EntityNameOrURIList) {

            EntityNameOrURIList temp = (EntityNameOrURIList)obj;
     ...
     * at the given index
     */
    public edu.mayo.cts2.framework.model.service.core.EntityNameOrURI getEntry(
            final int index)
    throws IndexOutOfBoundsException {
     ...
     */
    public java.util.List<edu.mayo.cts2.framework.model.service.core.EntityNameOrURI> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends edu.mayo.cts2.framework.model.service.core.EntityNameOrURI> iterateEntry(
    ) {
     ...
     */
    public edu.mayo.cts2.framework.model.service.core.EntityNameOrURI removeEntryAt(
            final int index) {
        EntityNameOrURI obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final edu.mayo.cts2.framework.model.service.core.EntityNameOrURI[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<edu.mayo.cts2.framework.model.service.core.EntityNameOrURI> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<edu.mayo.cts2.framework.model.service.core.EntityNameOrURI> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalEntityNameOrURIList.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.service.core.EntityNameOrURILis
     */

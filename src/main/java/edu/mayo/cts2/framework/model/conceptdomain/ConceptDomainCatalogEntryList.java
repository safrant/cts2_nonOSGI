...
/**
 * A collection of complete ConceptDomain resources that meet a
 * specified criteria.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ConceptDomainCatalogEntryList extends Directory
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<ConceptDomainCatalogEntryListEntry> _entryList;
    ...
    public ConceptDomainCatalogEntryList() {
        super();
        this._entryList = new java.util.ArrayList<ConceptDomainCatalogEntryListEntry>();
    }
    ...
    public void addEntry(
            final ConceptDomainCatalogEntryListEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ConceptDomainCatalogEntryListEntry> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof ConceptDomainCatalogEntryList) {

            ConceptDomainCatalogEntryList temp = (ConceptDomainCatalogEntryList)obj;
     ...
     * at the given index
     */
    public ConceptDomainCatalogEntryListEntry getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public ConceptDomainCatalogEntryListEntry[] getEntry(
        ...
        ConceptDomainCatalogEntryListEntry[] array = new ConceptDomainCatalogEntryListEntry[0];
     ...
     */
    public java.util.List<ConceptDomainCatalogEntryListEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ConceptDomainCatalogEntryListEntry> iterateEntry(
    ) {
     ...
     */
    public ConceptDomainCatalogEntryListEntry removeEntryAt(
            final int index) {
        ConceptDomainCatalogEntryListEntry obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final ConceptDomainCatalogEntryListEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<ConceptDomainCatalogEntryListEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<ConceptDomainCatalogEntryListEntry> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalConceptDomainCatalogEntryList.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.conceptdomain.ConceptDomainCatalogEntryList
     */

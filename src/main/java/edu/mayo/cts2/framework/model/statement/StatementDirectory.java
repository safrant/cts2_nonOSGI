...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry> _entryList;
    ...
    public StatementDirectory() {
        super();
        this._entryList = new java.util.ArrayList<edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry>();
    }
    ...
    public void addEntry(
            final edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry[] getEntry(
        ...
        edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry[] array = new edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry[0];
     ...
     */
    public java.util.List<edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry> iterateEntry(
    ) {
     ...
     */
    public edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<edu.mayo.cts2.framework.model.statement.StatementDirectoryEntry> entryList) {

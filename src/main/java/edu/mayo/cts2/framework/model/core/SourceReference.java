...
public class SourceReference extends NameAndMeaningReference
implements java.io.Serializable
{
    ...
    public SourceReference(final String defaultValue) {
        try {
    ...
    public boolean equals(
        ...
        if (obj instanceof SourceReference) {
            ...
            SourceReference temp = (SourceReference)obj;
    ...
    /**
     * Method unmarshalSourceReference.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling

...
public class ModelAttributeReference extends NameAndMeaningReference
implements java.io.Serializable
{
    ...
    public ModelAttributeReference() {
        super();
        setContent("");
    }

    public ModelAttributeReference(final String defaultValue) {
        try {
    ...
    public boolean equals(
        ...
        if (obj instanceof ModelAttributeReference) {

            ModelAttributeReference temp = (ModelAttributeReference)obj;
    ...
    /**
     * Method unmarshalModelAttributeReference.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling

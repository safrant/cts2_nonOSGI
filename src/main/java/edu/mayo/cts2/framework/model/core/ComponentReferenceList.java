...
public class ComponentReferenceList extends edu.mayo.cts2.framework.model.BaseCts2ModelObject 
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<ComponentReference> _entryList;
    ...
    public ComponentReferenceList() {
        super();
        this._entryList = new java.util.ArrayList<ComponentReference>();
    }
    ...
    public void addEntry(
            final ComponentReference vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ComponentReference> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof ComponentReferenceList) {

            ComponentReferenceList temp = (ComponentReferenceList)obj;
     ...
     * edu.mayo.cts2.framework.model.core.ComponentReference at the
     * given index
     */
    public ComponentReference getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public ComponentReference[] getEntry(
        ...
        ComponentReference[] array = new ComponentReference[0];
     ...
     */
    public java.util.List<ComponentReference> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ComponentReference> iterateEntry(
    ) {
     ...
     */
    public ComponentReference removeEntryAt(
            final int index) {
        ComponentReference obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final ComponentReference[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<ComponentReference> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<ComponentReference> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalComponentReferenceList.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.core.ComponentReferenceList
     */

...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<edu.mayo.cts2.framework.model.service.core.SortCriterion> _entryList;
    ...
    public SortCriteria() {
        super();
        this._entryList = new java.util.ArrayList<edu.mayo.cts2.framework.model.service.core.SortCriterion>();
    }
    ...
    public void addEntry(
            final edu.mayo.cts2.framework.model.service.core.SortCriterion vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends edu.mayo.cts2.framework.model.service.core.SortCriterion> enumerateEntry(
    ) {
     ...
     * edu.mayo.cts2.framework.model.service.core.SortCriterion at
     * the given index
     */
    public edu.mayo.cts2.framework.model.service.core.SortCriterion getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public edu.mayo.cts2.framework.model.service.core.SortCriterion[] getEntry(
        ...
        edu.mayo.cts2.framework.model.service.core.SortCriterion[] array = new edu.mayo.cts2.framework.model.service.core.SortCriterion[0];
     ...
     */
    public java.util.List<edu.mayo.cts2.framework.model.service.core.SortCriterion> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends edu.mayo.cts2.framework.model.service.core.SortCriterion> iterateEntry(
    ) {
     ...
     */
    public edu.mayo.cts2.framework.model.service.core.SortCriterion removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final edu.mayo.cts2.framework.model.service.core.SortCriterion[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<edu.mayo.cts2.framework.model.service.core.SortCriterion> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<edu.mayo.cts2.framework.model.service.core.SortCriterion> entryList) {
     ...
     * edu.mayo.cts2.framework.model.service.core.SortCriteria
     */

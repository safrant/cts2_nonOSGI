...
public class MapTargetListList extends edu.mayo.cts2.framework.model.BaseCts2ModelObject 
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<Entry> _entryList;
    ...
    public MapTargetListList() {
        super();
        this._entryList = new java.util.ArrayList<Entry>();
    }
     ...
     * collection
     */
    public java.util.Enumeration<? extends Entry> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof MapTargetListList) {

            MapTargetListList temp = (MapTargetListList)obj;
     ...
     * edu.mayo.cts2.framework.model.service.mapentry.Entry at the
     * given index
     */
     ...
     */
    public java.util.List<Entry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends Entry> iterateEntry(
    ) {
     ...
     */
    public Entry removeEntryAt(
            final int index) {
        Entry obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final java.util.List<Entry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<Entry> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalMapTargetListList.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.service.mapentry.MapTargetListList
     */

...
/**
 * An instance of CodeSystemVersion that meets a specified filter
 * criteria.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class CodeSystemVersionCatalogEntryListEntry extends DirectoryEntry
implements java.io.Serializable
{
     ...
     * Field _entry.
     */
    private CodeSystemVersionCatalogEntry _entry;
    ...
    public CodeSystemVersionCatalogEntryListEntry() {
        super();
    }
    ...
    public boolean equals(
        ...
        if (obj instanceof CodeSystemVersionCatalogEntryListEntry) {

            CodeSystemVersionCatalogEntryListEntry temp = (CodeSystemVersionCatalogEntryListEntry)obj;
            if (this._entry != null) {
    ...
    public void setEntry(
            final CodeSystemVersionCatalogEntry entry) {
        this._entry = entry;
    }

    /**
     * Method unmarshalCodeSystemVersionCatalogEntryListEntry.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling

...
public class CodeSystemCatalogEntryDirectory extends Directory
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<CodeSystemCatalogEntrySummary> _entryList;
    ...
    public CodeSystemCatalogEntryDirectory() {
        super();
        this._entryList = new java.util.ArrayList<CodeSystemCatalogEntrySummary>();
    }
    ...
    public void addEntry(
            final CodeSystemCatalogEntrySummary vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends CodeSystemCatalogEntrySummary> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof CodeSystemCatalogEntryDirectory) {

            CodeSystemCatalogEntryDirectory temp = (CodeSystemCatalogEntryDirectory)obj;
     ...
     * at the given index
     */
    public CodeSystemCatalogEntrySummary getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public CodeSystemCatalogEntrySummary[] getEntry(
        ...
        CodeSystemCatalogEntrySummary[] array = new CodeSystemCatalogEntrySummary[0];
     ...
     */
    public java.util.List<CodeSystemCatalogEntrySummary> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends CodeSystemCatalogEntrySummary> iterateEntry(
    ) {
     ...
     */
    public CodeSystemCatalogEntrySummary removeEntryAt(
            final int index) {
        CodeSystemCatalogEntrySummary obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final CodeSystemCatalogEntrySummary[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<CodeSystemCatalogEntrySummary> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<CodeSystemCatalogEntrySummary> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalCodeSystemCatalogEntryDirectory.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.codesystem.CodeSystemCatalogEntryDirectory
     */

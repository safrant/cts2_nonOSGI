...
public class EntityReferenceList extends edu.mayo.cts2.framework.model.BaseCts2ModelObject 
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<EntityReference> _entryList;
    ...
    public EntityReferenceList() {
        super();
        this._entryList = new java.util.ArrayList<EntityReference>();
    }
     ...
     * collection
     */
    public java.util.Enumeration<? extends EntityReference> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof EntityReferenceList) {

            EntityReferenceList temp = (EntityReferenceList)obj;
     ...
     * given index
     */
    public EntityReference getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public EntityReference[] getEntry(
        ...
        EntityReference[] array = new EntityReference[0];
     ...
     */
    public java.util.List<EntityReference> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends EntityReference> iterateEntry(
    ) {
     ...
     */
    public EntityReference removeEntryAt(
            final int index) {
        EntityReference obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final EntityReference[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<EntityReference> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<EntityReference> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalEntityReferenceList.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.core.EntityReferenceList
     */

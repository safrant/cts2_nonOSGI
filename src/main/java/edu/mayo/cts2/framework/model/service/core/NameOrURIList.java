...
public class NameOrURIList extends edu.mayo.cts2.framework.model.BaseCts2ModelObject 
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<edu.mayo.cts2.framework.model.service.core.NameOrURI> _entryList;
    ...
    public NameOrURIList() {
        super();
        this._entryList = new java.util.ArrayList<edu.mayo.cts2.framework.model.service.core.NameOrURI>();
    }
    ...
    public void addEntry(
            final edu.mayo.cts2.framework.model.service.core.NameOrURI vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends edu.mayo.cts2.framework.model.service.core.NameOrURI> enumerateEntry(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof NameOrURIList) {

            NameOrURIList temp = (NameOrURIList)obj;
     ...
     * given index
     */
    public edu.mayo.cts2.framework.model.service.core.NameOrURI getEntry(
            final int index)
    throws IndexOutOfBoundsException {
     ...
     */
    public java.util.List<edu.mayo.cts2.framework.model.service.core.NameOrURI> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends edu.mayo.cts2.framework.model.service.core.NameOrURI> iterateEntry(
    ) {
     ...
     */
    public edu.mayo.cts2.framework.model.service.core.NameOrURI removeEntryAt(
            final int index) {
        NameOrURI obj = this._entryList.remove(index);
        return obj;
    }
     ...
     */
    public void setEntry(
            final edu.mayo.cts2.framework.model.service.core.NameOrURI[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<edu.mayo.cts2.framework.model.service.core.NameOrURI> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<edu.mayo.cts2.framework.model.service.core.NameOrURI> entryList) {
        this._entryList = entryList;
    }

    /**
     * Method unmarshalNameOrURIList.
     * 
     * @param reader
     * @throws org.exolab.castor.xml.MarshalException if object is
     * null or if any SAXException is thrown during marshaling
     ...
     * edu.mayo.cts2.framework.model.service.core.NameOrURIList
     */

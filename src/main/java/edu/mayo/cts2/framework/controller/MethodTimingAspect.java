...
import edu.mayo.cts2.framework.service.core.timeout.Timeout;
...
public class MethodTimingAspect {
	...
	@Around("execution(public *"
	        + " edu.mayo.cts2.framework.service.webapp.rest.controller.*.*(..,edu.mayo.cts2.framework.webapp.rest.command.QueryControl,..))")

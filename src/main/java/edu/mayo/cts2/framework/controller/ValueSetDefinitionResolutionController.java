...
import edu.mayo.cts2.framework.service.restriction.ResolvedValueSetQueryServiceRestrictions;
import edu.mayo.cts2.framework.service.restriction.ResolvedValueSetResolutionEntityRestrictions;
...
public class ValueSetDefinitionResolutionController extends AbstractMessageWrappingController {
	...
	public Object getResolvedValueSetResolutionByLocalId(
        ...
        if(complete){
            ...
            ResolvedValueSetResult<URIAndEntityName> directory =
